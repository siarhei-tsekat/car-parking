...
public class LoginController extends HttpServlet {
    ...
    public static final String secret = "Yn2kjibddFAWtnPJ2AFlL8WXmohJMCvigQggaEypa5E="; // TODO: from a resource file
    ...
    private String generateToken(String issuer) {
        ...
        try {
            return Jwts.builder()
                    ...
                    .setExpiration(Date.from(Instant.now().plus(1, ChronoUnit.DAYS))) // TODO: make configurable from resource file
